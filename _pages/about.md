...
I am an incoming CS PhD student at [Stanford University](https://www.stanford.edu/). Before Stanford, I was a PhD student at [UC San Diego](https://ucsd.edu/), advised by [Hao Su](https://www.haosu.ai/) and [Henrik I. Christensen](https://hichristensen.com/). I also spent time at [Physical Intelligence](https://www.physicalintelligence.company/), [Boston Dynamics AI Institute](https://rai-inst.com/), and the [Stanford Vision and Learning Lab](https://svl.stanford.edu/). I received my Bachelor’s degree in Computer Science and Statistics from the [National University of Singapore](https://nus.edu.sg/) with the highest distinction, advised by [David Hsu](https://www.comp.nus.edu.sg/~dyhsu/). 
...
Our physical knowledge and skills are shaped by embodied experience, yet differences in embodiment fragment this experience across robots and hardware generations. My recent work asks how learning can cross these barriers, enabling agents to transfer across embodiments through new data sources and learning paradigms. The longer horizon is a shared learning process where physical form and intelligence co-evolve toward general embodied intelligence, and robots and humans collaborate beyond individual capabilities. I am excited by the prospect that this collective robotic intelligence extends human capability and deepens our understanding of ourselves.
<!-- I am excited by the prospect that collective robotic learning can empower robots to extend human capability and help us better understand ourselves. -->
<!-- I am excited by the prospect that the collective learning and wisdom empower robots to help us become better versions of ourselves. -->
